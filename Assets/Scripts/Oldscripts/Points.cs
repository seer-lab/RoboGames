...
public class Points : MonoBehaviour
{
	...
	public GameObject pointnumber;
		...
		void Update ()
		{
				...
				if (levelnum > 0) {
					if (levelnum < 100){this.GetComponent<Text> ().text = System.Convert.ToString (points) + " points";}
					...
					if (levelnum != currentlevel) {
								...
								case 1:
										...
										starttimer.GetComponent<Text> ().text = "Level " + System.Convert.ToString (levelnum) + " start time = " + System.Convert.ToString ((int)Time.time / 60) + ":";
										secs = (int)Time.time % 60;
										if (secs < 10) {
												starttimer.GetComponent<Text> ().text += "0" + System.Convert.ToString (secs);
										} else {
												starttimer.GetComponent<Text> ().text += System.Convert.ToString (secs);
										}
										break;
								case 2:
				...
				case 200:
					starttimer.GetComponent<Text>().text = "";
